...
//    #error "请在此处理可下发可上报数据及只上报数据示例,处理完成后删除该行"
    ...
    mcu_dp_value_update(DPID_TEMP_CURRENT,(DHT11.temp_int+DHT11.temp_deci)); //VALUE型数据上报;
    mcu_dp_value_update(DPID_HUMIDITY_VALUE,(DHT11.humi_int+DHT11.humi_deci)); //VALUE型数据上报;
